...
async function geocodeQuery(q, token, proximity) {
  ...
  if (res.status === 401 || res.status === 403) throw new Error("Mapbox bloqueou o acesso (" + res.status + "). A chave está restrita ao domínio — veja as configurações da chave no Mapbox.");
