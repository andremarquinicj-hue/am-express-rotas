...
/* ============================ Dashboard ============================ */
function Dashboard({ config, counts, totalKm, onCapture, onImport, onOptimize, onConfig, optimizing, hasRoute, userName, isOwner, onTeam, rotaNum, dayTotals, hasClosedRoutes, onNovaRota, onRotasDia, onVerSemLocal, dayMoney }) {
...
function App() {
  ...
  return html`<div class="app-shell">
    ...
    ${view === "home" && html`<${Dashboard} config=${config} counts=${counts} totalKm=${totalKm}
      ...
      onRotasDia=${() => setRotasSheet(true)} onVerSemLocal=${verSemLocal} dayMoney=${dayMoney}
